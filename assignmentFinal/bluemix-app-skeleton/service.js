...
Service.prototype.connect = function() {
  ...
  this.appClient.subscribeToDeviceEvents('senseHat', 'senbe27ebc08e03', 'yourEventName');
  }.bind(this));
...
Service.prototype.warningOn = function() {
  ...
  this.appClient.publishDeviceCommand("raspiGateway", "be27ebc08e03", "display", "json", cmd);
};
